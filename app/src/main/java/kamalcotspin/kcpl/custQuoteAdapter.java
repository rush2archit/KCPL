...
public class custQuoteAdapter extends SimpleAdapter {
     ...
     */
    public custQuoteAdapter(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to,ArrayList<Integer> coloredItems) {
